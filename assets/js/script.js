...
$(document).click(function(click){
	...
	//if clicked element doesnt have class item &optBtn, hide it
	if(!target.hasClass("item") && !target.hasClass("optionsButton")) {
		hideOptionsMenu();
	}
})
//hides menu once user scrolls
...
function createPlaylist(){
	...
	if(popup != null) {
		$.post("includes/handlers/ajax/createPlaylist.php", {
			name: popup, username: userLoggedIn })
			.done(function(error){
			if(error != "") {
				alert(error);
				return;
...
function showOptionsMenu(button) {
	...
	//calculating new position from top and left
...
//updating the time live on progressbar
